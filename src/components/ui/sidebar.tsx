...
>(
  (
    ...
    // CRITICAL FIX: On mobile, return null - NO desktop wrapper in DOM at all
    // The Sheet component above handles mobile completely
    // This prevents the desktop sidebar wrapper from affecting flex layout in RTL mobile
    return (
      <div
        ref={ref}
      ...
      >
        ...
        {/* FIX: Also collapse to 0 when state=collapsed to prevent layout shift in RTL */}
        <div
          data-sidebar-gap="true"
          className={cn(
