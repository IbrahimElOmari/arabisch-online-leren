-- ========= Fase 0: Database Schema Expansie (Aangepast) =========

-- 1. Forum Systeem - Alleen forum_threads toevoegen (forum_posts bestaat al)
...
-- 5. Bewerk bestaande forum_posts tabel om te werken met forum_threads
...
-- RLS Policies voor nieuwe Forum Threads
