-- PHASE 2: Part 3B - Final Constraints and Indexes (Fixed version)
...
-- ===============================================
-- STEP 5: ADD PERFORMANCE INDEXES (without CONCURRENTLY)
-- ===============================================
...
CREATE INDEX IF NOT EXISTS idx_bonus_points_student_id ON public.bonus_points(student_id);
CREATE INDEX IF NOT EXISTS idx_bonus_points_niveau_id ON public.bonus_points(niveau_id);

CREATE INDEX IF NOT EXISTS idx_awarded_badges_student_id ON public.awarded_badges(student_id);
CREATE INDEX IF NOT EXISTS idx_awarded_badges_niveau_id ON public.awarded_badges(niveau_id);
...
CREATE INDEX IF NOT EXISTS idx_auth_rate_limits_action_type ON public.auth_rate_limits(action_type);
