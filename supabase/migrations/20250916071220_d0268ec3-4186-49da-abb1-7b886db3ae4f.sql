...
BEGIN
  ...
  -- Award automatic badges for point milestones (100, 200, 300, ..., 1000)
  FOR new_badge_threshold IN 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000 LOOP
    IF total_niveau_points >= new_badge_threshold THEN
      INSERT INTO public.awarded_badges (
        ...
        progress_record.niveau_id,
        'automatic',
        'points_' || new_badge_threshold,
        new_badge_threshold || ' Punten Badge',
        'Behaald door ' || new_badge_threshold || ' punten te verdienen',
        new_badge_threshold
      )
