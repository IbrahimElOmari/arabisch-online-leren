  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        'noto-arabic': ['Noto Sans Arabic', 'Arial', 'sans-serif'],
        'inter': ['Inter', 'Helvetica Neue', 'sans-serif'],
        'arabic': ['Noto Sans Arabic', 'Amiri', 'Times New Roman', 'serif'],
        'dutch': ['Inter', 'Helvetica Neue', 'sans-serif'],
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "rtl-pulse": "rtl-pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite",
        "rtl-fade-enter": "rtl-fade-enter 0.3s ease-out",
        "rtl-skeleton-loading": "rtl-skeleton-loading 1.5s infinite",
